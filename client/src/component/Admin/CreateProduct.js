                ...
                <div className="col-lg-4 col-md-4 mt-2">
                    <div className="card upload">
                        <div className="card-body">
                            <input type="file" name="productImg" className="form-control" onChange={handleUpload} required />
                            {
                                loading ?
                                    ...
                                    <div id="file_img">
                                        ...
                                        <img src={image ? image.url : "https://www.transcriptionstar.com/images/Hassle-Free-Upload.svg"} alt="" />
                                    </div>
